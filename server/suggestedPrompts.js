 ...
 * 
 * Auto-generates contextually relevant suggested prompts based on user role
 * and optionally the current context (active case, hospital, etc.).
 */
...
/**
 * Get suggested prompts for a given role and context.
 * @param {string} role - User role
 * @param {Object} context - Optional context IDs
 * @returns {string[]} Array of suggested prompt strings
 */
